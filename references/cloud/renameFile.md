# 重命名文件
重命名文件，需要提供 SID，safekey，timeStamp，文件 ID，文件名称，返回执行后的说明。

## URL

`https://root_url/partner/api/cloud.api.php?action=renameFile`  
...
| fileId | 是 | 无 | 	文件 ID |	无|
| fileName | 是 | 1-128个字符，不区分中英文，超出会自动截取为128个字 | 文件名称 | 无|
