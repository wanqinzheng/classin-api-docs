...
- 注意seatNum上台人数参数，例：传1时，表示1v0，台上只显示老师头像。默认为7，即1v6。
...
| aiSummaryConfig | 否 | object | AI 相关设置 | 
| 　└ chapter |	否 |integer|	章节总结开关 |	0/1 默认0 | 	  
| 　└ subtitle |	否 |integer|	字幕列表开关 |	0/1 默认 0 |	 
| 　└ teachingAnalysis | 否| integer |	授课分析开关 | 0/1   	如果传teachingAnalysisAgentId必须传这个参数 |
| 　└ teachingAnalysisAgentId |否 | integer | 授课分析智能体id | 预置智能体ID：<br>"课堂诊断（K12数理）"   5000930(默认)  <br>"课堂诊断（K12人文）" 5000931  <br>"课堂研析（公立校数理）"  5000932 <br>"课堂研析（公立校人文）"  5000933  | 	
| aiRiskMonitor | 否   | integer   | AI教学风险监测                        |    	0/1 默认 0     |  
...
| 121601020 | 业务参数错误 ：{具体错误信息} |
| 121601021 | 课程不属于当前机构下 |
| 121601022 | 课程不是标准课 |
| 121601023 | 课程已过期 |
| 121601070  | 单个课程下课堂数量超过限制 |
| 121604007  | 不支持设置OMO站播  |
| 121604008|机构未开启AI教学风险监控功能|
| 122301070  | 单个班级内课堂数量超过限制  |
| 142601001 |智能体不存在|
